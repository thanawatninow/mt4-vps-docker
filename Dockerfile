...
RUN apt-get update && \
    apt-get install -y curl tar unzip sudo net-tools xrdp xfce4 xfce4-goodies && \
    apt-get install -y wine64 winetricks xterm firefox && \
    apt-get clean && rm -rf /var/lib/apt/lists/*


RUN useradd -m forex && echo "forex:god@641054" | chpasswd && adduser forex sudo
...
RUN mkdir -p /home/forex/mt4/experts && chown -R forex:forex /home/forex/mt4
